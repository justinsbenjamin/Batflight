...
#betas. β0: initial flight time in s; β_day: slope (average increase in flight time per day in control group)
#β_daytreat: average *additional* increase in flight time per day (relative to control) in treatment group
